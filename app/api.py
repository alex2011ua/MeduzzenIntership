...
def show_results(request: Request):
    ...
    description = """
Этот товар поражает своей невероятной функциональностью и стильным дизайном, добавляя радости и комфорта в повседневную жизнь. Высокое качество материалов и инновационные технологии делают этот товар идеальным выбором для тех, кто ценит комфорт и радость от использования. Этот товар не только отличается превосходным качеством, но и приносит непередаваемую радость своим удобством использования и стильным дизайном.
